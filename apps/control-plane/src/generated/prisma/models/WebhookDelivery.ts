...
export type WebhookDeliveryWhereInput = {
  ...
  taskId?: Prisma.StringNullableFilter<"WebhookDelivery"> | string | null
...
export type WebhookDeliveryScalarWhereWithAggregatesInput = {
  ...
  taskId?: Prisma.StringNullableWithAggregatesFilter<"WebhookDelivery"> | string | null
...
export type WebhookDeliveryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"deliveryId" | "event" | "taskId" | "receivedAt", ExtArgs["result"]["webhookDelivery"]>
...
export interface WebhookDeliveryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const webhookDeliveryWithDeliveryIdOnly = await prisma.webhookDelivery.findMany({ select: { deliveryId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many WebhookDeliveries and only return the `deliveryId`
   * const webhookDeliveryWithDeliveryIdOnly = await prisma.webhookDelivery.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more WebhookDeliveries and only return the `deliveryId`
   * const webhookDeliveryWithDeliveryIdOnly = await prisma.webhookDelivery.updateManyAndReturn({
   *   select: { deliveryId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface WebhookDeliveryFieldRefs {
  ...
  readonly taskId: Prisma.FieldRef<"WebhookDelivery", 'String'>
